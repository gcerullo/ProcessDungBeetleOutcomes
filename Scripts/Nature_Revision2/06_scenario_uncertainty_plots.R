...
if (length(rds_files) == 0) {
  stop("No input files found in: ", rds_folder, call. = FALSE)
}

#select which starting landscape and scenario ruls you want
# NR2 INPUT: set this index to choose a specific BestScenario file.
selected_file_index <- 1L
rds_files
df <- readRDS(rds_files[[selected_file_index]])
...
ggsave(file.path(nr2_figures_dir, "loser_dungbeetle_uncertainty_plot.pdf"),
       loser_dungbeetle_uncertainty_plot,
       width = 15, height = 11.69, units = "in", 
       bg = "white")

ggsave(file.path(nr2_figures_dir, "int1lgrp_dungbeetle_uncertainty_plot.pdf"),
       int1_dungbeetle_uncertainty_plot,
       width = 15, height = 11.69, units = "in", 
       bg = "white")

ggsave(file.path(nr2_figures_dir, "all_sp_uncertainty_plot.pdf"),
       all_sp_uncertainty_plot,
       width = 12, height = 12, units = "in", 
       bg = "white")


ggsave(file.path(nr2_figures_dir, "all_sp_chunk1.pdf"),
       all_sp_split1,
       width = 12, height = 12, units = "in", 
       bg = "white")

ggsave(file.path(nr2_figures_dir, "all_sp_chunk2.pdf"),
       all_sp_split2,
       width = 12, height = 12, units = "in", 
       bg = "white")
...
#PNG ####
# Save the loser species combined plots as A4-sized output
ggsave(file.path(nr2_figures_dir, "loser_dungbeetle_uncertainty_plot.png"),
       loser_dungbeetle_uncertainty_plot,
       width = 15, height = 11.69, units = "in", 
       bg = "white")

ggsave(file.path(nr2_figures_dir, "int1lgrp_dungbeetle_uncertainty_plot.png"),
       int1_dungbeetle_uncertainty_plot,
       width = 15, height = 11.69, units = "in", 
       bg = "white")

ggsave(file.path(nr2_figures_dir, "all_sp_uncertainty_plot.png"),
       all_sp_uncertainty_plot,
       width = 12, height = 12, units = "in", 
       bg = "white")


ggsave(file.path(nr2_figures_dir, "all_sp_chunk1.png"),
       all_sp_split1,
       width = 12, height = 12, units = "in", 
       bg = "white")

ggsave(file.path(nr2_figures_dir, "all_sp_chunk2.png"),
       all_sp_split2,
       width = 12, height = 12, units = "in", 
       bg = "white")
